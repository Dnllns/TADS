...
public interface Table <R,C,V> {
	...
	// TODO - containsRowKey(Object rowKey), containsColumnKey(Object columnKey) 
...
// Se puede poner alguno más del XXXXall para completar en dificultad
	...
	public interface Cell <R,C,V>{
		...
		C getColumnKey();
		V getValue();
		V setValue(V value ); // Si se sobreescribe este valor, se debería realizar la sobreescritura también en la tabla
		// Esto último se ha añadido al final. Tener en cuenta SOLO para subir nota.
		// Añadido (pero importante para tests): 
